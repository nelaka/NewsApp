...
public final class QueryUtils {
    ...
    /**
     * Query the Guardian API dataset and return a list of {@link Result} objects.
     */
            ...
            if (baseJsonResponse.has("response")) {
                ...
                for (int i = 0; i < resultArray.length(); i++) {
                    ...
                    if (currentResult.has("sectionName")) {
                        ...
                        sectionName = currentResult.getString("sectionName");
                    }

                    String publicationDate = null;
                    if (currentResult.has("webPublicationDate")) {
                        // Extract the value for the key called "webPublicationDate"
                        publicationDate = currentResult.getString("webPublicationDate");
                    }

                    String title = null;
                    if (currentResult.has("webTitle")) {
